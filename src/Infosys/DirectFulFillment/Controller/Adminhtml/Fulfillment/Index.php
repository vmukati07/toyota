...
class Index extends \Magento\Backend\App\Action implements HttpGetActionInterface
{
     ...
     * @see _isAllowed()
     */
    const ADMIN_RESOURCE = 'Infosys_DirectFulFillment::index';
    ...
    public function execute()
    {
        ...
        if ($shipment) {
            ...
            $this->_view->getPage()->getConfig()->getTitle()->prepend(__('Direct Fulfillment'));
            $this->_view->getPage()->getConfig()->getTitle()->prepend(__('Create Direct Fulfillment'));
