 ...
 */
class EPCProductAttribute implements DataPatchInterface
{
    /**
     * @var EavSetupFactory
     */
    ...
    public function apply()
    {
        ...
        $attributes = [
            'cubic' => [
                'group_name' => 'Dimensional Shipping',
                'type' => 'varchar',
                'label' => 'Dimension Cubic',
                'input' => 'text',
                'source' => '',
                'option' => '',
                'filterable' => false,
            ...
            'engineering_foot_notes' => [
                'group_name' => 'PDP Custom Attributes',
                'type' => 'varchar',
                'label' => 'Engineering Foot Notes',
                'input' => 'textarea',
                'source' => '',
                'option' => '',
                'filterable' => false,
    ...
    private function updateProductAttribute()
    {
        ...
        $eavSetup->updateAttribute($entityType, 'primary_image_indicator', 'frontend_input', 'text', null);
        $eavSetup->updateAttribute($entityType, 'primary_image_indicator', 'backend_type', 'text', null);
         
        $eavSetup->updateAttribute($entityType, 'specification_text', 'is_wysiwyg_enabled', 1, null);
    }
