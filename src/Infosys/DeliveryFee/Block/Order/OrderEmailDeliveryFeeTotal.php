...
namespace Infosys\DeliveryFee\Block\Order;

use Magento\Framework\DataObject;
use Magento\Framework\View\Element\AbstractBlock;

/**
 * Responsible for rendering any delivery fee on an amount to the order sales email template
 */
class OrderEmailDeliveryFeeTotal extends AbstractBlock
{
	/**
