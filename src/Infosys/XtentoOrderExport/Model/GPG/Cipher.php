...
class Cipher
{
    ...
    */
    public function f1($x0, $x1, $x2, $x3)
    {
        $T1 = Cipher::$T1;
        
        return
        $this->utility->b1($T1[$x0 & 0xff]) | ($this->utility->b1($T1[($x1 >> 0x8) & 0xff]) << 0x8) |
            ($this->utility->b1($T1[($x2 >> 0x10) & 0xff]) << 0x10)
            | ($this->utility->b1($T1[$this->utility->zshift($x3, 0x18)]) << 0x18);
    }
}
