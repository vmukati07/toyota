...
class AddCustomerAttribute implements DataPatchInterface, PatchRevertableInterface
{
    ...
    public function apply()
    {
        ...
        $attribute = $customerSetup->getEavConfig()->getAttribute(Customer::ENTITY, 'dcs_guid');
    ...
    public function revert()
    {
        $this->moduleDataSetup->getConnection()->startSetup();
        $customerSetup = $this->customerSetupFactory->create(['setup' => $this->moduleDataSetup]);
        $customerSetup->removeAttribute(\Magento\Customer\Model\Customer::ENTITY, 'dcs_guid');
        $this->moduleDataSetup->getConnection()->endSetup();
    }
