...
return [
        ...
        'default' => [
            ...
            'dev' => [
                ...
                'js' => [
                    ...
                    'minify_exclude' => '/tiny_mce//v1/songbird'
                ],
                'css' => [
    ...
    'modules' => [
        ...
        'Auctane_Api' => 1,
        'BlueAcorn_Core' => 1,
        'BlueAcorn_AdminApprove' => 1,
        'BlueAcorn_IssueCollector' => 1,
        'BlueAcorn_RebuildUrlRewrite' => 1,
        'BlueAcorn_ReviewsImport' => 1,
        ...
        'Pitbulk_SAML2' => 1,
        'Xtento_XtCore' => 1,
        'Infosys_AttributeField' => 1,
        'Infosys_CategoryAttribute' => 1,
        'Infosys_CheckoutVIN' => 1,
        'Infosys_Cidr' => 1,
        'Infosys_CustmerCentralAttPatch' => 1,
        'Infosys_CreateCategory' => 1,
        'Infosys_CreateWebsite' => 1,
        'Infosys_Csp' => 1,
        'Infosys_CustomerCentral' => 1,
        'Infosys_CustomOrderNumber' => 1,
        'Infosys_CustomProductAttribute' => 1,
        'Xtento_OrderExport' => 1,
        'Infosys_CustomerSSO' => 1,
        'Infosys_CustomerWebsiteOrders' => 1,
        'Signifyd_Connect' => 1,
        'ShipperHQ_Shipper' => 1,
        'Infosys_DealerSavings' => 1,
        'Infosys_DealerShippingCost' => 1,
        'Infosys_DeliveryFee' => 1,
        'Xtento_TrackingImport' => 1,
        'Infosys_DisableCommerceFrontend' => 0,
        'Infosys_EPCconnect' => 1,
        'Infosys_EdamImageModifier' => 1,
        'Infosys_ExtendedOrderGridColumn' => 1,
        'Infosys_HazmatShipping' => 1,
        'Infosys_IndexerBatchsize' => 1,
        'Infosys_OrderAttribute' => 1,
        'Infosys_OrderEmailTemplates' => 1,
        'Infosys_OrderStatus' => 1,
        'Infosys_OrderView' => 1,
        'Infosys_PayflowPro' => 1,
        'Infosys_PaymentConfigGraphQL' => 1,
        'ParadoxLabs_TokenBase' => 1,
        'Infosys_PriceAdjustment' => 1,
        'Infosys_PrimaryKeyFixes' => 1,
        'Infosys_ProductAttribute' => 1,
        'Infosys_ProductSaleable' => 1,
        'Infosys_Vehicle' => 1,
        'Infosys_Quote' => 1,
        'Infosys_RateLimiting' => 1,
        'Infosys_Reports' => 1,
        'Infosys_RollingSitemap' => 1,
        'Infosys_SalesReport' => 1,
        'Infosys_Search' => 1,
        'Infosys_SearchByVIN' => 1,
        'Infosys_SearchTerm' => 1,
        'Infosys_ShipStationOrders' => 1,
        'Infosys_ShippingRestriction' => 1,
        'Infosys_SignifydFingerprintCart' => 1,
        'Infosys_StorePickUp' => 1,
        'Infosys_Test1' => 1,
        'Infosys_Translation' => 1,
        'Infosys_UnsubscribeEmailToNewsletter' => 1,
        'Infosys_UpdateProductCount' => 1,
        'Infosys_VehicleSearch' => 1,
        'Infosys_VehicleFitment' => 1,
        'Infosys_ProductsByVin' => 1,
        'Infosys_Vimal' => 1,
        'Infosys_WebsiteProductsMapping' => 1,
        'Infosys_WishlistGraphQl' => 1,
        'Infosys_XtentoOrderExport' => 1,
        'Xtento_PdfCustomizer' => 1,
        'Xtento_ProductExport' => 1,
        'Infosys_YMMSearchGraphQL' => 1,
        'Klarna_Core' => 1,
        ...
        'Infosys_PaymentWebsiteAssociation' => 1,
        'PayPal_Braintree' => 1,
        'PayPal_BraintreeGraphQl' => 1,
        'Infosys_AdminRole' => 0,
        'ShipperHQ_Common' => 1,
        'ShipperHQ_Logger' => 1,
        'Infosys_DealerMarkupPrice' => 1,
        'Infosys_DealerChanges' => 1,
        ...
        'Vertex_TaxStaging' => 1,
        'Infosys_DirectFulFillment' => 1,
        'Infosys_XtentoPdfCustomizer' => 1,
        'Infosys_AemBase' => 0,
        'Infosys_CoreChargeAttribute' => 1,
        'Infosys_XtentoProductExport' => 1,
        'Yireo_Whoops' => 1,
        'Yotpo_Yotpo' => 1
    ],
    'admin_user' => [
