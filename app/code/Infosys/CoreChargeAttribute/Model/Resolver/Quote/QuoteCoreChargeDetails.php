...
namespace Infosys\CoreChargeAttribute\Model\Resolver\Quote;
...
/**
 * Class to update core charge details in the cart query response
 */
class QuoteCoreChargeDetails implements ResolverInterface
{
    ...
    public function resolve(Field $field, $context, ResolveInfo $info, array $value = null, array $args = null)
    {
        ...
        if ($quote) {
            $output = [];
            $core_charge_details = $quote->getData($field->getName());
