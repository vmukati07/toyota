 ...
 */
namespace Infosys\EPCconnect\Observer;
...
use Infosys\EPCconnect\Model\Config\Configuration as EPCHelper;
...
class AfterImportDataObserver extends \Magento\CatalogUrlRewrite\Observer\AfterImportDataObserver
{
    ...
    public function execute(Observer $observer)
    {
        ...
        if($this->epchelper->isCanonicalUrlrewriteGenerateEnabled()){
