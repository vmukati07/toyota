...
namespace Infosys\DisableCommerceFrontend\Plugin\Checkout\Controller\OnePage;
...
class SaveOrder{
     ...
     *
     * @param SaveOrder $subject
     * @param Closure $proceed
     */
    public function aroundExecute(\Magento\Checkout\Controller\OnePage\SaveOrder $subject,
    \Closure $proceed)
    {
