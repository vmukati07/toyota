...
namespace Infosys\AemBase\Rewrite\Magento\Sitemap\Model\ResourceModel\Catalog;
...
/**
 * Replacement for the core file to adjust how URL keys are returned.
 *
 * Note that this is a modified version of \Magento\Sitemap\Model\ResourceModel\Catalog\Product
 *
 * @see \Magento\Sitemap\Model\ResourceModel\Catalog\Product
 * @see \Infosys\AemBase\Rewrite\Magento\Sitemap\Model\ResourceModel\Catalog\Product
 */
class Product extends \Magento\Framework\Model\ResourceModel\Db\AbstractDb
{
    ...
    public function getCollection($storeId)
    {
        ...
        // Our adjustment to the query, that returns the url_key attribute
        $this->_joinAttribute($store->getId(), 'url_key', 'url_key');
